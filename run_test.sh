...
#RECIPE="bae tf-adj textfooler pwws"
#EXP_NAME="s1/discussion/linear_kernel"
#PARAM_PATH="params/reduce_dim_100_linear.json"
#SCEN="s1"
#ESTIM="MCD"
#START_SEED=0
#END_SEED=2
...
#    --attack_type $recipe --scenario $SCEN --cov_estimator $ESTIM\
#    --start_seed $START_SEED --end_seed $END_SEED --model_params_path $PARAM_PATH\
#    --exp_name $EXP_NAME --gpu $GPU --target_model ${TARGET_MODEL[i]} --include_fae
#
#  done
#done
#
